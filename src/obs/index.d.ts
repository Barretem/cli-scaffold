...
export interface IObsConfig {
  'BUILD_OBS_KEY': string,
  'BUILD_OBS_SECRET': string,
  'BUILD_OBS_BUCKET': string,
  'BUILD_OBS_ENDPOINT': string
}

export interface ISPaaSBuildConfig extends IObsConfig {
...
export interface IBuildFunc {
  ...
  transportFileToObs: () => Promise<boolean>
